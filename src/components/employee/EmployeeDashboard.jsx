...
const fsmChip = (paused, tracking, mode, syncStatus) => {
  ...
  if (syncStatus === SyncStatus.ERROR) {
    return {
      label: 'FAILED_RETRY',
      cls: 'bg-rose-50 text-rose-700 border-rose-200 dark:bg-rose-500/10 dark:text-rose-rose-300 dark:border-rose-500/30',
    }
  }
...
export default function EmployeeDashboard({
  ...
  const agentStatusLabel = tracking
    ? `Chronos: Active — ${
        modeLabel[operationalMode] || 'Working Hours Mode'
      }`
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div>
              ...
              <div className="mt-1 flex flex-wrap items-center gap-2">
                <span className={`badge border ${fsm.cls}`}>
                  {fsm.label}
                </span>
